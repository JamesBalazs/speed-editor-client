...
var featureReportDefaultState = []byte{0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
var featureReportHostChallenge = []byte{0x06, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}
...
func sendHostChallenge(d *hid.Device) {
	...
	if !bytes.Equal(data[0:2], []byte{0x06, 0x02}) {
